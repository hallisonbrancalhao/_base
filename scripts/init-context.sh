...
echo ""
echo "5. ${CYAN}Teste o AI-Guard (auditoria de código IA)${NC}"
echo "   /audit-report                  → Projetos afetados"
echo "   /audit-report all              → Codebase completo"
echo "   /audit-report lib:user         → Apenas um escopo"
echo "   → Invoca performance-auditor + security-auditor + architecture-reviewer em paralelo"
echo ""
